...
/// Style-guide spin box with custom paint — reliable on Android (QSS arrows/text fail there).
class ComfySpinBox : public QSpinBox
{
    Q_OBJECT

public:
    explicit ComfySpinBox(QWidget *parent = nullptr);
